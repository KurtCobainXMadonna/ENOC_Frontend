export function SoundLibrary({ sounds, onDrop }) {
  ...
  return (
    <div style={{
      ...
      width: 180, display: "flex", flexDirection: "column", flexShrink: 0,
    }}>
            ...
            {filtered.filter(s => s.category === cat).map(sound => (
              ...
              >
                <div style={{
                  ...
                  flexShrink: 0, color: "var(--neon-violet)",
                }}>
                  <Icon.Waveform />
                </div>
                <div style={{ minWidth: 0 }}>
                  <div style={{ fontSize: 11, fontFamily: "var(--font-mono)", color: "var(--text-primary)", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                    {sound.name}
                  </div>
                  <div style={{ fontSize: 9, color: "var(--text-muted)", marginTop: 1 }}>.mp4</div>
                </div>
              </div>
            ))}
          </div>
